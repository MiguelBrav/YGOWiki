...
{
     public class AllTypeCardsPageQueryHandler : UseCaseBase<AllTypeCardsPageQuery, ApiResponse>
    {
        ...
        public override async Task<ApiResponse> Execute (AllTypeCardsPageQuery request)
        {
