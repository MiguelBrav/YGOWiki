...
{
     public class AllRaritiesQueryHandler : IRequestHandler<AllRaritiesQuery, ApiResponse>
    {
        ...
        public AllRaritiesQueryHandler(YGOWiki.YGOWikiClient client, ICacheService cacheService, IConfiguration config, IMemoryCache cache)
        {
            _client = client;
        ...
        public async Task<ApiResponse> Handle(AllRaritiesQuery request, CancellationToken cancellationToken)
        {
