...
{
     public class AllSpecialMonsterCardsPageQueryHandler : UseCaseBase<AllSpecialMonsterCardsPageQuery, ApiResponse>
    {
        ...
        public override async Task<ApiResponse> Execute(AllSpecialMonsterCardsPageQuery request)
        {
