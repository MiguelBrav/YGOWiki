...
{
    public class TypeCardByIdQueryHandler : UseCaseBase<TypeCardByIdQuery, ApiResponse>
    {
        ...
        public override async Task<ApiResponse> Execute (TypeCardByIdQuery request)
        {
