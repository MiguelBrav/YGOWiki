...
{
    public class AttributeByIdQueryHandler : UseCaseBase<AttributeByIdQuery, ApiResponse>
    {
        ...
        public override async Task<ApiResponse> Execute(AttributeByIdQuery request)
        {
