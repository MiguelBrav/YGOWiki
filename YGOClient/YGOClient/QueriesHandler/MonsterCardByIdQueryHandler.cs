...
{
    public class MonsterCardByIdQueryHandler : UseCaseBase<MonsterCardByIdQuery, ApiResponse>
    {
        ...
        public MonsterCardByIdQueryHandler(YGOWiki.YGOWikiClient client, ICacheService cacheService, IConfiguration config, IMemoryCache cache)
        {
            _client = client;
        ...
        public override async Task<ApiResponse> Execute(MonsterCardByIdQuery request)
        {
